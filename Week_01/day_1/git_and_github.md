...
NOTE:  should choose a meaningful name for your repos that accurately describes your work. (Rather than "Codeclan Homework", for example.) Is likely that future employers will want to see your Github accounts, so well-named repos are really helpful.
